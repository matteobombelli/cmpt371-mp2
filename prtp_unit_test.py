...
class TestPRTP(unittest.TestCase):
    ...
    def _server_loop(self):
        ...
        try:
            ...
            while self.server_running:
                # Polling loop
                addr = server.sock.receive()
                if addr:
                    while True:
                        msg = server.sock.get_segment(addr)
                        if msg:
    ...
    def test_02_connection_closing(self):
        ...
        if server_conn_exists:
            ...
            self.assertEqual(status, Connection.Status.CLOSING, 
    ...
    def test_03_reliability_packet_loss(self):
        ...
        for i in range(msg_count):
            ...
            self.client.sock.send(chunk, (SERVER_IP, SERVER_PORT))
    ...
    def test_04_integrity_corruption(self):
        ...
        self.client.sock.send(test_msg, (SERVER_IP, SERVER_PORT))
